...
\RS{1}{A greedy strategy is poorly equipped when many decision points are present.}
...
\RS{3}{Connecting the degree of exploration to the total number of simulations yields superior performance.}
...
\RS{4}{Disregarding the values of rewards used in favour of their ordering sacrifices little performance in favour of broader applicability of \soft.}
