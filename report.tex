...
\newcommand{\rock}{\hbox{\textsc{rocksample}}~}
\newcommand{\poc}{\hbox{\textsc{pocman}}~}
\newcommand{\egreedy}{\hbox{$\varepsilon$-\textsc{greedy}}~}
\newcommand{\eroulette}{\hbox{$\varepsilon$-\textsc{roulette}}~}
\newcommand{\soft}{\hbox{\textsc{softmax}}~}
\newcommand{\rsoft}{\hbox{\textsc{r-softmax}}~}
